...
var AutoCompleteList = function (props) {
    ...
    var autoCompleteItems = Object.keys(items).map(function (key, index) {
        if (items[key].type === 'FOLDER') {
            return (React__default.createElement("span", { className: activeItemIndex === index
    ...
    return React__default.createElement("div", { className: "preview-list" }, autoCompleteItems);
};

var History = function (props) {
    var history = props.history;
    var commandList = history.map(function (command) { return (React__default.createElement("li", { key: command.id },
        command.input,
        React__default.createElement("span", { className: "commandResult" }, command.result))); });
    return (React__default.createElement("div", { id: "history-container" },
        React__default.createElement("ul", { "aria-label": "terminal-history" }, commandList)));
};

var InputPrompt = function (props) {
    var path = props.path, inputPrompt = props.inputPrompt;
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement("span", { "data-testid": "input-prompt-path" }, path),
        "\u00A0",
        React__default.createElement("span", { id: "inputPrompt" }, inputPrompt)));
};
...
var Input = React__default.forwardRef(function Input(props, ref) {
    ...
    return (React__default.createElement("div", { id: "input-container", spellCheck: false },
        React__default.createElement("form", { onSubmit: handleSubmit },
            React__default.createElement(InputPrompt, { path: currentPath, inputPrompt: inputPrompt }),
            React__default.createElement("input", { "aria-label": "terminal-input", autoComplete: "none", autoCapitalize: "none", autoCorrect: "off", type: "text", value: inputValue, onChange: handleChange, onKeyDown: handleKeyDown, onKeyUp: handleKeyUp, readOnly: readOnly, ref: ref }))));
});
 ...
 */
function convertPathToInternalFormat(pathStr) {
    return pathStr
        .replace(/^\/+/g, '')
        .split('/')
 ...
 */
function handleDotDotInPath(pathStr) {
    var currentDotDots = 0;
    var pathArr = pathStr.split('/').filter(function (path) { return path.length > 0; });
    ...
    return pathArr.filter(function (path) { return path !== '..'; }).join('/');
}
/**
 ...
 */
function convertInternalPathToExternal(pathStr) {
    return ('/' +
        pathStr
            .split('.')
            .filter(function (path) { return path !== 'children'; })
            .join('/'));
}
/**
...
var index = /*#__PURE__*/Object.freeze({
    __proto__: null,
    convertPathToInternalFormat: convertPathToInternalFormat,
    handleDotDotInPath: handleDotDotInPath,
    convertInternalPathToExternal: convertInternalPathToExternal,
...
function cd(fileSystem, currentPath, targetPath) {
    return new Promise(function (resolve, reject) {
        ...
        if (has_1(fileSystem, internalCdPath) &&
            get_1(fileSystem, internalCdPath).type !== 'FILE') {
            resolve({
                updatedState: {
...
var LsResult = function (props) {
    var lsResult = props.lsResult;
    var lsItems = Object.keys(lsResult).map(function (key) {
        if (lsResult[key].type === 'FOLDER') {
            return (React__default.createElement("li", { className: "ls-folder", key: key },
                React__default.createElement(SvgFolder, null),
                " ",
                React__default.createElement("span", null, key)));
        }
        return (React__default.createElement("li", { className: "ls-file", key: key },
            React__default.createElement(SvgFile, null),
            " ",
            React__default.createElement("span", null, key)));
    });
    return React__default.createElement("ul", { className: "terminal-ls-list" }, lsItems);
};
...
function ls(fileSystem, currentPath, targetPath) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        resolve({
            commandResult: (React__default.createElement(LsResult, { lsResult: buildItemList(targetFolderContents) })),
        });
    });
}
/**
...
var TerminalImage = function (_a) {
    var src = _a.src;
    return (React__default.createElement("img", { src: src }));
};
    ...
    return new Promise(function (resolve, reject) {
        ...
        if (file.type === 'FILE') {
            if (isImageExtension(file.extension)) {
                resolve({
                    commandResult: (React__default.createElement(TerminalImage, { src: file.content })),
                });
            }
            else {
                resolve({
...
var TerminalContext = React__default.createContext({});

var HelpMenu = function () {
    return (React__default.createElement(TerminalContext.Consumer, null, function (commands) { return (React__default.createElement("div", { id: "help-container" },
        React__default.createElement("ul", { "aria-label": "help-menu" }, Object.keys(commands)
            .filter(function (command) { return commands[command].description; })
            .map(function (command) { return (React__default.createElement("li", { key: command },
            React__default.createElement("span", { className: "help-command-name" }, command),
            " -",
            ' ',
            React__default.createElement("span", null, commands[command].description))); })))); }));
};
...
var Terminal = /** @class */ (function (_super) {
    ...
    function Terminal() {
        ...
        _this.terminalInput = React__default.createRef();
                ...
                switch (_f.label) {
                    ...
                    case 6:
                        updatedHistory = history.concat({
                            input: (React__default.createElement(Input, { currentPath: currentPath, inputValue: inputValue, inputPrompt: inputPrompt, readOnly: true })),
    ...
    Terminal.prototype.render = function () {
        ...
        return (React__default.createElement(TerminalContext.Provider, { value: commandList },
            React__default.createElement("div", { id: "terminal-wrapper" },
                React__default.createElement(History, { history: history }),
                React__default.createElement("div", { ref: this.inputWrapper },
                    React__default.createElement(Input, { currentPath: currentPath, handleChange: this.handleChange, handleKeyDown: this.handleKeyDown, handleSubmit: this.handleSubmit, inputValue: inputValue, inputPrompt: inputPrompt, ref: this.terminalInput, readOnly: false })),
                React__default.createElement("div", { "aria-label": "autocomplete-preview", className: "tab-complete-result" }, autoCompleteItems && (React__default.createElement(AutoCompleteList, { items: autoCompleteItems, activeItemIndex: autoCompleteActiveItem }))))));
    };
    return Terminal;
}(Component));

export { Terminal, autoComplete, index as utilities };
