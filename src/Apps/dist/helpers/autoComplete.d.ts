 ...
 */
export declare function getUpdatedInputValueFromTarget(currentInputValue: string, currentTargetPath: string, targetFormattedName: string, targetPathToUpdate?: string): string;
/**
 ...
 */
export declare function formatItem(fileSystem: ItemListType, itemKey: number): string;
/**
 ...
 */
export declare function getTargetPath(currentTargetPath: string): string;
